/*
  # Fix Kudos Statistics Views

  1. Changes
    - Drop existing views if they exist
    - Recreate kudos_stats_weekly view with correct point system
    - Recreate kudos_stats_monthly view with correct point system
    - Add proper RLS policies for the views

  2. Security
    - Enable RLS for the views
    - Add policies to allow authenticated users to view the statistics
*/
