/*
  # Create Kudos Statistics Views

  1. New Views
    - kudos_stats_weekly: Weekly statistics for kudos given and received
    - kudos_stats_monthly: Monthly statistics for kudos given and received
    - top_kudos_recipients: Top recipients by category
  ...
  3. Changes
    ...
    - Create new views with updated point calculations
